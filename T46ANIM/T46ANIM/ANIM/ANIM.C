 ...
 * RETURNS: None.
 */
VOID ND4_AnimCopyFrame( HDC hDC )
{
  ND4_RndCopyFrame(hDC);
...
VOID ND4_AnimFlipFullScreen( VOID )
{
  ...
  {
    SetWindowPos(ND4_Anim.hWnd, HWND_TOPMOST, SaveRC.left, SaveRC.top, SaveRC.right - SaveRC.left, 
